...
/* film-grain + vignette overlay across the whole app */
.stApp::before{
    content:"";
...
/* ---------- HERO ---------- */
.hero-wrap{ padding: 6px 4px 0 4px; position:relative; z-index:1; animation: fade-up .7s ease; }
.hero-badge{
...
# ----------------------------------------------------------------------
with st.sidebar:
    st.markdown('<div class="brand">DATA<span>CLEAN</span></div>', unsafe_allow_html=True)
...
st.markdown('<div class="hero-title">DATA CLEANING<br>STUDIO</div>', unsafe_allow_html=True)
st.markdown(
...
film_divider()
st.caption("Data Cleaning Studio — built with pandas, NumPy, Streamlit & Plotly.")